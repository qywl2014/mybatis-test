...
import com.wulang.localdatabase.dao.UserFriendMapper;
...
//@SpringBootTest
public class LocalDatabaseApplicationTests {
...
//    @Autowired
    ...
    public void count() throws Exception{
        ...
        UserFollowMapper userFollowMapper=sqlSession.getMapper(UserFollowMapper.class);
        long startTime=System.currentTimeMillis();
        Integer count=userFollowMapper.count();
        long endTime=System.currentTimeMillis();
        System.out.println("--------"+(endTime-startTime));
    ...
    public void isFollowed() throws Exception{
        ...
        UserFollowMapper userFollowMapper=sqlSession.getMapper(UserFollowMapper.class);
        long startTime=System.currentTimeMillis();
        Integer count=userFollowMapper.isFollowed(100,1);
        long endTime=System.currentTimeMillis();
        System.out.println("--------"+(endTime-startTime));
        boolean ifFollowed=count!=0;
        System.out.println("ifFollowed:"+ifFollowed);
    }
    ...
    public void sqlSessionTest() throws Exception{
        SqlSession sqlSession=getSqlSession();
        Userinfo userinfo=sqlSession.selectOne("com.wulang.localdatabase.dao.UserinfoMapper.selectOne");
        System.out.println(userinfo);
    }

    @Test
    public void selectOneByResultTypeTest() throws Exception{
        SqlSession sqlSession=getSqlSession();
        Userinfo userinfo=sqlSession.selectOne("com.wulang.localdatabase.dao.UserinfoMapper.selectOneByResultType");
        System.out.println(userinfo);
    }

    @Test
    public void selectOneByResultTypeTestWishInterface() throws Exception{
        SqlSession sqlSession=getSqlSession();
